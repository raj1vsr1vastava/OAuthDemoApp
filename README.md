# OAuth 2.0 Demo App using React built with MSAL React and Microsoft identity platform

This app demonstrates OAuth2.0 concepts using [MSAL React](https://www.npmjs.com/package/@azure/msal-react)

## Features

This app demonstrates the following MSAL React concepts:
